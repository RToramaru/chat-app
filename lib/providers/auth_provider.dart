...
class AuthProvider extends ChangeNotifier {
  ...
  Status _status = Status.naoInicializado;
    ...
    if (googleUser != null) {
      ...
      if (firebaseUser != null) {
        ...
        if (document.isEmpty) {
          ...
          await prefs.setString(
              FirestoreConstants.nome, userChat.displayName);
          await prefs.setString(FirestoreConstants.sobre, userChat.aboutMe);
          await prefs.setString(
              FirestoreConstants.telefone, userChat.phoneNumber);
        }
        _status = Status.autenticado;
        notifyListeners();
        return true;
      } else {
  ...
  Future<void> googleSignOut() async {
    _status = Status.naoInicializado;
